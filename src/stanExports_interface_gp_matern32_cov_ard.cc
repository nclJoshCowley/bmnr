...
#include "stanExports_interface_gp_matern32_cov_ard.h"

RCPP_MODULE(stan_fit4interface_gp_matern32_cov_ard_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_interface_gp_matern32_cov_ard")
