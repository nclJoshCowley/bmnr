...
#include "stanExports_bmnr_mvnorm.h"

RCPP_MODULE(stan_fit4bmnr_mvnorm_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_bmnr_mvnorm")
